...
#ifndef ART_DRIVE_CONTROLLER__SPEED_LIMITER_HPP_
#define ART_DRIVE_CONTROLLER__SPEED_LIMITER_HPP_
...
public:
   ...
   * \param [in, out] v  Velocity [m/s]diff
...
#endif  // ART_DRIVE_CONTROLLER__SPEED_LIMITER_HPP_
